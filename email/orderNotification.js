														...
														<tr>
															<td class="pad"
																...
																<div align="center" class="alignment">
																	<div style="max-width: 248px;"><img alt="Rapidex Logo"
																			height="auto" src="${process.env.NEXT_PUBLIC_BASE_URL}/assets/images/rapidex-logo.png"
																			style="display: block; height: auto; border: 0; width: 100%;"
																			title="Rapidex" width="248" /></div>
																</div>
															</td>
														</tr>
													</table>
												...
												<td class="column column-1"
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<h1
																	style="margin: 0; color: #000000; direction: ltr; font-family: TimesNewRoman, 'Times New Roman', Times, Baskerville, Georgia, serif; font-size: 32px; font-weight: 700; letter-spacing: -0.5px; line-height: 1.3; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 42px;">
																	<span class="tinyMce-placeholder"
																		style="word-break: break-word;">Thank you for your order!</span>
																</h1>
															</td>
														</tr>
													</table>
																	...
																	<table border="0" cellpadding="0" cellspacing="0"
																		...
																		<tr>
																			<td class="divider_inner"
																				style="font-size: 1px; line-height: 1px; border-top: 2px solid #fbd6b8;">
																				<span
															...
															<td class="pad" style="text-align:center;">
																<div align="center" class="alignment"><a
																		...
																		target="_blank"> <span class="button"
																			style="background-color: #f97316; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 30px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; display: inline-block; font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: 700; mso-border-alt: none; padding-bottom: 8px; padding-top: 8px; padding-left: 28px; padding-right: 28px; text-align: center; width: auto; word-break: keep-all; letter-spacing: 0.5px;"><span
																				style="word-break: break-word; line-height: 28px;">View My Order</span></span> </a>
																</div>
															</td>
														</tr>
													</table>
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																...
																<div
																	style="color:#f7f1ed;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:700;letter-spacing:1px;line-height:1.2;text-align:left;mso-line-height-alt:17px;">
																	<p style="margin: 0;">Thanks for shopping with Rapidex</p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad"
																...
																<div
																	...
																	<p style="margin: 0;"><strong>Have a question?</strong> We’re here to help. <a
																			href="${process.env.NEXT_PUBLIC_BASE_URL}/contact" rel="noopener"
