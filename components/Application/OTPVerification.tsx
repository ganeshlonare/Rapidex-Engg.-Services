        ...
        <div>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(handleOtpVerification)} >
                    ...
                    <div className='mb-3'>
                        <ButtonLoading loading={loading} type="submit" text="Verify" className="w-full cursor-pointer btn-orange" />
                        <div className='text-center mt-5'>
                            {!isResendingOtp ?
                                <button onClick={resendOTP} type='button' className='text-orange-500 hover:text-orange-600 cursor-pointer hover:underline'>Resend OTP</button>
                                :
