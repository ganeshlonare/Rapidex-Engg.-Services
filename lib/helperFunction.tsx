...
type StatusType = 'pending' | 'processing' | 'shipped' | 'delivered' | 'cancelled' | 'unverified';

export const statusBadge = (status: StatusType): React.ReactElement => {
    const statusColorConfig: Record<StatusType, string> = {
        pending: 'bg-blue-500',
