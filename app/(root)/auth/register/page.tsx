                ...
                <div className='mt-5'>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(handleRegisterSubmit)} >
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input type="text" placeholder="Rapidex" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                            ...
                            <div className='mb-3'>
                                <ButtonLoading loading={loading} type="submit" text="Create Account" className="w-full cursor-pointer btn-orange" />
                            </div>
                            <div className='text-center'>
                                <div className='flex justify-center items-center gap-1'>
                                    <p>Already have account?</p>
                                    <Link href={WEBSITE_LOGIN} className='text-orange-500 hover:text-orange-600 underline'>Login!</Link>
                                </div>
                            </div>
                        </form>
                    </Form>
