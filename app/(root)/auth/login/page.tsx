...
import { USER_DASHBOARD, WEBSITE_REGISTER, WEBSITE_RESETPASSWORD, WEBSITE_SHOP } from '@/routes/WebsiteRoute'
    ...
    const handleOtpVerification = async (values) => {
        try {
            ...
            if (searchParams.has('callback')) {
                ...
                otpResponse.data.role === 'admin' ? router.push(ADMIN_DASHBOARD) : router.push(WEBSITE_SHOP)
            }
                        ...
                        <div className='mt-5'>
                            <Form {...form}>
                                <form onSubmit={form.handleSubmit(handleLoginSubmit)} >
                                    ...
                                    <div className='mb-3'>
                                        <ButtonLoading loading={loading} type="submit" text="Login" className="w-full cursor-pointer btn-orange" />
                                    </div>
                                    <div className='text-center'>
                                        ...
                                        <div className='mt-3'>
                                            <Link href={WEBSITE_RESETPASSWORD} className='text-orange-500 hover:text-orange-600 underline'>Forgot password?</Link>
                                        </div>
                                    </div>
                                </form>
                            </Form>
