...
export async function POST(request) {
    try {
        ...
        try {
            ...
            await sendMail('Rapidex - Order placed successfully.', validatedData.email, orderNotification(mailData))

        } catch (error) {
            // ignore email notification failure to not block order creation
        }
